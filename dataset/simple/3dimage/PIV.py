...
winsize =80 # pixels, interrogation window size in frame A 64
searchsize =120  # pixels, search in image B 72
...
velocity_stack = np.stack(velocity_stack)
velocity_stack[velocity_stack>20] = 0
